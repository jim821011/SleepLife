<template>
    <div>
        <div class="text-right mt-4">
            <button class="btn btn-primary" @click="openModal(true)">新建立的優惠券</button>
        </div>
        ...
        <pagination :page="pagination" @changePage="getCoupon"></pagination>

        <!-- Modal -->
        <div class="modal fade" id="couponModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="col">
                            ...
                            <div class="form-row">
                                ...
                                <label for="due_date">有效天數</label>
                                    <input type="number" class="form-control" id="due_date"
...
export default {
    ...
    methods: {
        ...
        updateCoupon() {
            ...
            vm.$http[modalType](api, {data:coupon})
            .then(()=>{
        ...
        openModal(isNew, item) {
            ...
            if(isNew){
                ...
                this.coupon.due_date = Math.ceil((this.coupon.due_date - Math.round(new Date().getTime() / 1000))/86400);
                this.isNew = false;
            }
        },
        deleteCoupon() {
