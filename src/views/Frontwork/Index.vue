<template>
    <div>
            ...
            <swiper ref="headSwiper" :options="headSwiper">
                <swiper-slide>
                    <div class="bg-cover bg-img-1">
                        <div class="bg-brightness d-flex justify-content-center align-items-center">
                ...
                <swiper-slide>
                    <div class="bg-cover bg-img-2">
                        <div class="bg-brightness d-flex flex-column justify-content-center align-items-center">
                            <span class="header-title">多款實用又實惠的寢具</span>
                            <router-link class="btn-shopping text-light" to="/production">手刀搶購</router-link>
                        </div>
                    </div>
                </swiper-slide>
                <swiper-slide>
        ...
        <section class="my-md-9">
            ...
            <div class="bg-blue-l">
                <div class="container">
                    <div class="row animate__animated animate__slowe" ref="fadeInLeft" 
                        ...
                        <div class="col-md-6">
                            <div class="row justify-content-end flex-nowrap">
                                ...
                                <div class="intro-overflow d-none d-md-block">
                                    <h2 class="intro-title-column">為什麼要睡好床<span class="intro-title-qus">?</span></h2>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="my-md-9">
            ...
            <div class="bg-blue-l">
                <div class="container">
                    <div class="row animate__animated animate__slowe" ref="fadeInRight" :class="{'animate__fadeInRight':fadeInRightShow}">
                        <div class="col-md-6 order-2 order-md-1">
                            <div class="row flex-row-reverse flex-nowrap">
                                <div class="intro-overflow d-none d-md-block">
                                    <h2 class="intro-title-column">良好的睡眠品質<br><span class="intro-title-space">有何好處</span><span class="intro-title-qus">?</span></h2>
                                </div>
                                <div class="intro-text">
                                    <p>
                                        好的睡眠品質可以讓身體機能正常運作且有效的運作轉，也可以提升免疫力；因大腦可以有效運作，
                                        做事效率會提升，專注力也會提升。 而在心理方面，好的睡眠品質可使情緒穩定，舒緩壓力，令人心情愉悅。
                                    </p>                               
                                </div>
                            </div>
                        </div>
        ...
        <section class="mb-5 mb-md-6">
            <div class="container">
                ...
                <div class="row" @mouseover="shopswiperStop" @mouseleave="shopswiperStart">
                            ...
                            <div class="col">
                                <div class="tool-card mb-4 mb-md-0">
                                    <router-link :to="{path:`product_detail/${item.id}`}">
                                        <div class="bg-cover" :style="{backgroundImage: `url(${item.imageUrl})`,height: `315px`}">                             
                                            <div class="production-img d-flex justify-content-center h-100 align-items-center">
                                               商品資訊                                          
                                            </div>                                
                                        </div>
                                    </router-link>                
                                    <div class="d-flex flex-column text-center text-primary tool-card-item border-bottom">
...
export default {
    ...
    computed: {
      ...
      NewFiveProduction() { // 只取前5樣最新加入的商品
    ...
    methods: {
        ...
        shopswiperStop() { // 最新商品幻燈片暫停 配合mouseover事件
            this.shopswiper.autoplay.stop()
        },
        shopswiperStart() { // 最新商品幻燈片開始運作 配合mouseleave事件
