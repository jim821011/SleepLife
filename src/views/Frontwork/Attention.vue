        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col mt-9" v-if="products.length === 0">
                    <h2 class="text-center text-primary font-weight-bolder">目前並無關注商品</h2>
                        ...
                        <tbody>
                            <tr v-for="item in products" :key="item.id">
                                ...
                                <td class="align-middle">
                                    <button class="btn btn-outline-primary btn-sm w-100" @click="addToCart(item)">
                                        <i class="fas fa-spinner fa-spin" v-if="status.loadingItem === item.id"></i>
                                        <i class="fas fa-shopping-cart"></i>
                                    </button>
                                </td>
                                <td class="align-middle">
                                    <button class="btn btn-outline-danger btn-sm" @click.prevent="removeAttention(item)">刪除</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
