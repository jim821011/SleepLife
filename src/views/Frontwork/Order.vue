    ...
    <div class="mt-9 mb-5">
      <div class="container px-0 px-md-3">
        <div class="row no-gutters">
          <div class="col-md-8 h-100" id="form-list">
            <div class="bg-primary px-4 pt-4 text-white">
              <h2 class="m-0 font-weight-bolder text-center">基本資料</h2>            
            </div>

            <validation-observer v-slot="{ invalid }">
              <form class="bg-primary p-4 font-weight-bolder text-white font-20"  
                    ...
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input
                          ...
                          id="name" placeholder="請輸入姓名" name="姓名"
                    ...
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input
                          ...
                          id="email" placeholder="請輸入電子信箱" name="電子信箱"
                          :class="{'is-invalid':errors[0]}"
                ...
                <validation-provider rules="required" v-slot="{ errors }">
                  ...
                  <div class="form-group">
                    ...
                    <input
                      type="text" class="form-control form-control-lg"
                      id="phone" placeholder="請輸入電話" name="電話"
                      :class="{'is-invalid':errors[0]}"
                ...
                <validation-provider rules="required" v-slot="{ errors }">
                  ...
                  <div class="form-group">
                    ...
                    <input
                      type="text" class="form-control form-control-lg mt-2"
                      id="address" placeholder="請輸入完整地址" name="地址"
                      :class="{'is-invalid':errors[0]}"
                ...
                <div class="form-group">
                  ...
                  <textarea
                    name="" id="comment" class="form-control" cols="30" rows="5"
          ...
          <div class="col-md-4" id="book-list">
            <div class="ml-0 mt-5 ml-md-3 mt-md-0">
              <div>
                <h2 class="text-center py-3 bg-main-l font-24 text-primary font-weight-bolder m-0">
                  訂單摘要
                </h2>
                <div class="border border-top-0 p-3">
                  ...
                  <div class="d-flex align-item-center text-primary my-2">
                    ...
                    <div class="coupon-btn ml-auto">
                      <button class="btn btn-main-l btn-sm w-100"
                        @click="useCoupon">
                        套用
                      </button>
                    </div>
                  ...
                  <span
                    class="text-danger d-block" v-if="noCouponPrice > totalPrice">
                    已套用優惠券
                  </span>
                  <span
                  ...
                  <div
                    class="d-flex justify-content-between text-primary font-20 mt-3 font-weight-bolder">
                    <span>總計</span>
